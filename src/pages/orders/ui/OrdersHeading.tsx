...
const OrdersHeading: React.FC = () => {
    return (
        <div className='flex flex-col mt-[20px] pr-[24px] pl-[24px]'>
            <span className='font-medium lg:text-[24px] text-[#33331F]'>
                Мои заказы
            </span>

            <div className='flex justify-between mt-[16px]'>
                <div className='flex gap-[9px]'>
                    <button type='button' className='h-[44px] w-[164px] items-center justify-center gap-[8px] flex font-medium text-[16px] text-[#FCFDFF] bg-[#ED0028] border-none outline-none rounded-[10px] cursor-pointer'>
                    ...
                    <button type='button' className='h-[44px] w-[209px] items-center justify-center gap-[8px] flex font-medium text-[16px] text-[#333333] bg-white border border-[#F1F1F1] outline-none rounded-[10px] cursor-pointer'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
