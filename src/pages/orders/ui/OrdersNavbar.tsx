...
const OrdersNavbar: React.FC = () => {
    return (
        <div className='hidden lg:flex items-center gap-[12px] pr-[24px]  pl-[24px]'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M1.875 11.25C1.875 9.42664 2.59933 7.67795 3.88864 6.38864C5.17795 5.09933 6.92664 4.375 8.75 4.375C8.91576 4.375 9.07473 4.44085 9.19194 4.55806C9.30915 4.67527 9.375 4.83424 9.375 5V10.625H15C15.1658 10.625 15.3247 10.6908 15.4419 10.8081C15.5592 10.9253 15.625 11.0842 15.625 11.25C15.625 13.0734 14.9007 14.822 13.6114 16.1114C12.322 17.4007 10.5734 18.125 8.75 18.125C6.92664 18.125 5.17795 17.4007 3.88864 16.1114C2.59933 14.822 1.875 13.0734 1.875 11.25Z" fill="#B9B9B9" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10.625 2.5C10.625 2.33424 10.6908 2.17527 10.8081 2.05806C10.9253 1.94085 11.0842 1.875 11.25 1.875C13.0734 1.875 14.822 2.59933 16.1114 3.88864C17.4007 5.17795 18.125 6.92664 18.125 8.75C18.125 8.91576 18.0592 9.07473 17.9419 9.19194C17.8247 9.30915 17.6658 9.375 17.5 9.375H11.25C11.0842 9.375 10.9253 9.30915 10.8081 9.19194C10.6908 9.07473 10.625 8.91576 10.625 8.75V2.5Z" fill="#B9B9B9" />
            </svg>
