...
const DeliveryHeading: React.FC<Props> = ({ deliveryCreateClick }) => {
  return (
    <div className="flex flex-col lg:mt-[20px] lg:pr-[24px] lg:pl-[24px] mt-[32px] pr-[16px] pl-[16px]">
      ...
      <div className="flex justify-between mt-[16px] flex-wrap lg:flex-nowrap w-full">
        <div className="flex lg:gap-x-[8px] lg:gap-y-[8px] gap-x-[8px] gap-y-[8px] flex-wrap lg:flex-nowrap w-full">
          <button
            type="button"
            className="h-[44px] w-[calc(50%-4px)] lg:w-[169px] items-center justify-center gap-[8px] flex font-medium text-[16px] text-[#333333] bg-white border border-[#F1F1F1] outline-none rounded-[10px] cursor-pointer"
          >
            <svg
          ...
          <button
            type="button"
            className="h-[44px] w-[calc(50%-4px)] lg:w-[131px] items-center justify-center flex font-medium text-[16px] text-[#333333] bg-white border border-[#F1F1F1] outline-none rounded-[10px] cursor-pointer"
          >
            Выбрать все
          </button>
        ...
        <button
          ...
          type="button"
          className="h-[44px] lg:w-[168px] w-full mt-[8px] lg:mt-0 items-center justify-center gap-[8px] flex font-medium text-[16px] text-[#FCFDFF] bg-[#ED0028] border-none outline-none rounded-[10px] cursor-pointer lg:order-none"
        >
          <svg
          ...
          >
            <path
              d="M4.92896 12H19.0711M12 19.0711V4.92893"
              stroke="#FCFDFF"
              stroke-width="1.8"
