...
const DeliveryNavbar: React.FC = () => {
  return (
    <div className="hidden lg:flex items-start gap-[12px] pr-[24px]  pl-[24px]">
      ...
      <a href="/delivery" className="font-medium text-[14px] text-[#B9B9B9] h-[17px]">
        Доставка
      </a>
    </div>
  );
