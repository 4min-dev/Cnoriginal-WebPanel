...
const MobileHeader: React.FC = () => {
    ...
    if (window.location.href.includes('authorization') || window.location.href.includes('registration')) return null

    return (
        <div className={`flex lg:hidden justify-between items-center pt-[60px] pl-[14px] pr-[16px]`}>
            <button type='button' className='w-[48px] h-[48px] flex items-center justify-center outline-none border border-[#F3F3F3] bg-white shadow-[0_0_25.8px_0_#0f0f2b26] rounded-[10px]' onClick={openAside}>
